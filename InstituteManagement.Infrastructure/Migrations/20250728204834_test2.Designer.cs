...
namespace InstituteManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250728204834_test2")]
    partial class test2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InstituteManagement.Infrastructure.Identity.AppRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InstituteManagement.Infrastructure.Identity.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InstituteManagement.Core.Entities.Person", b =>
                {
                    b.OwnsOne("InstituteManagement.Core.Common.ValueObjects.EmailAddress", "Email", b1 =>
                        {
            ...
            modelBuilder.Entity("InstituteManagement.Infrastructure.Identity.AppUser", b =>
                {
                    b.HasOne("InstituteManagement.Core.Entities.Person", "Person")
                        .WithOne()
                        .HasForeignKey("InstituteManagement.Infrastructure.Identity.AppUser", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("InstituteManagement.Infrastructure.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("InstituteManagement.Infrastructure.Identity.AppUser", null)
                        .WithMany()
